...
SolrCore Instance Directory without the 'spell' field
=====================================================

This configuration removes the spell field in order to improve performance
when indexed a large amount of files (GB). When indexing files, the spell
field gets large and affects search performance. 
